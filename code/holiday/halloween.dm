...
/datum/event/spooky/start() //This has to be here because else you get errors with spooky storage not being a defined type.
	..()
...
/mob/living/simple_animal/hostile/retaliate/clown/insane/proc/stalk()
	if(timer == 0)
		timer = rand(5,15)
		playsound(pick('sound/spookoween/scary_horn.ogg','sound/spookoween/scary_horn2.ogg', 'sound/spookoween/scary_horn3.ogg'), 300, 1)
	return
